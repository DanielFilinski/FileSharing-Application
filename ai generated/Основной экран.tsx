...
const FirmSideInterface = () => {
  ...
  const SidebarItem = ({ icon, text, isActive, onClick, children, hasIcon = true, isSubItem = false }) => (
    <div>
      <div 
      ...
      >
        ...
        {hasIcon && icon && <div className={`sidebar-icon ${icon.className}`} style={{
          width: '20px',
          height: '20px',
          marginRight: '12px',
          display: 'flex',
          ...
          color: 'white',
          borderRadius: '4px',
          background: icon.className ? undefined : 'transparent'
        }}>{icon.text || icon}</div>}
        {!hasIcon && (
          <div style={{ 
            fontSize: '18px', 
  ...
  const ActionButton = ({ children, variant = 'default', onClick, icon }) => {
    ...
    return (
      <button
        ...
        onMouseEnter={(e) => {
          if (variant === 'primary') {
            e.target.style.background = 'linear-gradient(135deg, #106ebe, #005a9e)';
            e.target.style.transform = 'translateY(-1px)';
            e.target.style.boxShadow = '0 4px 12px rgba(0, 120, 212, 0.3)';
          } else if (variant === 'success') {
            e.target.style.background = 'linear-gradient(135deg, #0e6e0e, #0c5a0c)';
            e.target.style.transform = 'translateY(-1px)';
            e.target.style.boxShadow = '0 4px 12px rgba(16, 124, 16, 0.3)';
          } else {
        ...
        onMouseLeave={(e) => {
          if (variant === 'primary') {
            e.target.style.background = 'linear-gradient(135deg, #0078d4, #106ebe)';
          } else if (variant === 'success') {
            e.target.style.background = 'linear-gradient(135deg, #107c10, #0e6e0e)';
          } else {
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '0 12px' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <SidebarItem
                ...
                onClick={setActiveNavItem}
              >
                <SidebarItem text="To End User" onClick={setActiveNavItem} hasIcon={false} isSubItem={true} />
                <SidebarItem text="From End User" onClick={setActiveNavItem} hasIcon={false} isSubItem={true} />
              </SidebarItem>
            </div>
